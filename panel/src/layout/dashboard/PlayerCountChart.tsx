...
const chartConfig = {
    ...
    desktop: {
        label: 'Desktop',
        color: 'oklch(75.54% .1534 231.639)',
    },
    mobile: {
        label: 'Mobile',
        color: 'oklch(65.54% .1534 280.639)',
    },
...
export function PlayerCountChart() {
    ...
    const average = React.useMemo(
        () =>
            Math.round(
                chartData.reduce((acc, curr) => acc + curr.desktop, 0) / chartData.length
            ),
        []
    );
    ...
    const currentValue = React.useMemo(() => {
        ...
        return latest ? latest.desktop : 0;
    }, []);

    const trend = React.useMemo(() => {
        const recent = chartData.slice(-7);
        const avg = recent.reduce((acc, curr) => acc + curr.desktop, 0) / recent.length;
        ...
        <div className="space-y-4">
            ...
            >
                <div className="stat-card">
                    <div
                        className="group relative overflow-hidden bg-gradient-to-br from-card/80 via-card/60 to-card/80 border border-border/40 shadow-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(75,54%,15.34%,0.4)] hover:border-[oklch(75.54% .1534 231.639)] rounded-2xl">
                        <div
                ...
                <div className="stat-card">
                    <div
                        ...
                        <div className="relative z-10 text-center p-4">
                            <div className="text-2xl font-bold text-foreground">{average}</div>
            ...
            <div
                className="p-4 rounded-lg bg-gradient-to-br from-card/50 to-card/30 border border-border/50 backdrop-blur-sm"
            >
                <ChartContainer
                    config={chartConfig}
                ...
                >
                    ...
                    >
                        ...
                        <ChartTooltip
                            content={
                                <ChartTooltipContent
                                    className="w-[150px] bg-card/95 backdrop-blur-sm border border-border/50 shadow-xl"
                                    nameKey="views"
